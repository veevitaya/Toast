...
const GREETINGS: Record<TimeSlot, Record<WeatherCondition, { headlines: string[]; subs: string[]; emoji: string }>> = {
  ...
  evening: {
    clear: { headlines: ["Clear evening, great eats!", "Dinner under the stars ✨", "Cocktails & clear skies 🍸"], subs: ["Perfect night for rooftop dining", "Bangkok nights + good food = magic", "Dinner first, drinks after — or both?", "Rooftop cocktails kind of weather"], emoji: "🌙" },
    cloudy: { headlines: ["Cozy dinner time", "Evening comfort food", "Dinner & drinks weather"], subs: ["Cloudy night, warm food", "Nothing beats a proper dinner tonight", "Speakeasy vibes on a cloudy night"], emoji: "☁️" },
    rainy: { headlines: ["Rainy night feast!", "Rain makes dinner better"], subs: ["Hot pot weather has arrived", "The sound of rain + sizzling food", "Cozy bar or hot pot — you pick"], emoji: "🌧️" },
    ...
    hot: { headlines: ["Hot night, cool eats", "Warm evening ahead", "Cold drinks, hot night 🍹"], subs: ["Night market weather if you're brave", "Spicy food to match the heat?", "Rooftop bar with a breeze sounds right"], emoji: "🔥" },
    humid: { headlines: ["Humid evening dining", "Muggy night out"], subs: ["AC restaurant sounds perfect tonight", "Cool down with your dinner choices", "Ice-cold cocktails are calling"], emoji: "💧" },
    unknown: { headlines: ["Dinner time!", "What's for dinner?", "Dinner & drinks tonight?"], subs: ["Bangkok's best is waiting for you", "Time for something delicious", "Food first, cocktails after?"], emoji: "🍽️" },
  },
  late_night: {
    clear: { headlines: ["Midnight munchies!", "Night owl eats 🦉", "One more drink? 🥂"], subs: ["Clear night, perfect for street food", "The best food comes out after dark", "Late-night bars are calling"], emoji: "🌙" },
    cloudy: { headlines: ["Late night cravings?", "Can't sleep, won't starve", "Nightcap time?"], subs: ["Cloudy night comfort food", "Late night = no judgment zone", "One last cocktail before bed?"], emoji: "☁️" },
    rainy: { headlines: ["Rainy midnight snack", "Rain + ramen = yes"], subs: ["The best time for a warm bowl", "Nothing cozier than late-night noodles in the rain", "Rainy night whiskey bar vibes"], emoji: "🌧️" },
    ...
    hot: { headlines: ["Hot night hunger!", "Too warm to sleep?"], subs: ["Might as well eat something cold", "Late night ice cream run?", "Cold beer on a hot night — classic"], emoji: "🔥" },
    humid: { headlines: ["Humid night hunger", "Sticky night snacking"], subs: ["Cool treats for a muggy night", "Bangkok never sleeps and neither do you", "Ice-cold drinks for a sticky night"], emoji: "💧" },
    unknown: { headlines: ["Late night craving?", "Still up? Let's eat!", "Nightcap & bites? 🍸"], subs: ["The city that never sleeps, never stops eating", "Your midnight feast awaits", "Bangkok's bars are still serving"], emoji: "🌙" },
  },
};

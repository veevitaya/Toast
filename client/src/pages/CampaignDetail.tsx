...
export default function CampaignDetail() {
  ...
  if (!campaign) {
    return (
      <div className="w-full min-h-[100dvh] bg-background flex items-center justify-center" data-testid="campaign-not-found">
  ...
  return (
    <div className="w-full min-h-[100dvh] bg-background pb-40" data-testid="campaign-detail-page">

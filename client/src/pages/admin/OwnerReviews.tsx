    ...
    <div className="space-y-6" data-testid="owner-reviews-page">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-xs text-gray-400">View customer feedback</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5" data-testid="stat-five-star">
          ...
          <p className="text-2xl font-bold text-gray-800">{fiveStarCount}</p>
          <p className="text-xs text-gray-400 mt-1">{Math.round((fiveStarCount / MOCK_REVIEWS.length) * 100)}% of reviews</p>
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-5" data-testid="stat-total-helpful">
          ...
          <p className="text-2xl font-bold text-gray-800">{MOCK_REVIEWS.reduce((s, r) => s + r.helpful, 0)}</p>

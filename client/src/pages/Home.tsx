              ...
              >
                <div className="px-5 pb-6 pt-1">
                  <div className="flex items-center gap-3 mb-3">
                    <img src={toastLogoPath} alt="Toast" className="h-11 w-auto" data-testid="img-collapsed-logo" />
                  ...
                  <div className="grid grid-cols-2 gap-2.5">
                    ...
                    >
                      <img src={toastCharPath} alt="" className="h-[50px] w-auto object-contain flex-shrink-0" />
                    ...
                    >
                      <img src={toastWafflePath} alt="" className="h-[46px] w-auto object-contain flex-shrink-0 ml-1" />
        ...
        <div className={`flex-1 min-h-0 hide-scrollbar relative ${refineOpen ? "flex flex-col overflow-hidden" : "overflow-y-auto pb-24"}`} style={{ overscrollBehavior: "contain" }}>
          <div className="px-6 pt-2 pb-3" style={refineOpen ? { display: "none" } : undefined}>
            ...
            <div className="flex items-start justify-between gap-3">
              ...
              <img
                ...
                alt="Toast"
                loading="lazy"
                className="h-[3.25rem] w-auto flex-shrink-0 mt-[29px]"
          ...
          <div className="px-6 pt-2 pb-4" style={refineOpen ? { display: "none" } : undefined}>
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              >
                <img src={toastCharPath} alt="" className="h-[74px] w-auto object-contain flex-shrink-0" />
              ...
              >
                <img src={toastWafflePath} alt="" className="h-[64px] w-auto object-contain flex-shrink-0" />
                <div className="min-w-0 flex-1">

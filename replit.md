...
- **Restaurant Owner System:** Dedicated login and dashboard for restaurant owners to manage their restaurant details, menus, promotions, and view performance analytics. Includes a claim system for restaurants. Mock owner: `owner@toastbkk.com` / `owner2024` (Jay Fai, premium). Owner Settings has Profile/Notifications/Subscription/Payments tabs. Payments tab supports credit card and Thai bank account setup (mock). Owner Promotions page has working campaign creation form.
